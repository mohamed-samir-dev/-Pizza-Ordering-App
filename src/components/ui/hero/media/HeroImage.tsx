      ...
      <div className="relative">
        ...
        >
          <Image
            ...
            alt="Fresh, hot pizza with melted cheese and toppings, showcasing Pizza Express quality"
            fill
        ...
        <div className="absolute -top-4 sm:-top-6 -right-3 sm:-right-6 lg:right-9 bg-linear-to-r from-red-500 to-pink-500 rounded-full p-2 sm:p-3 shadow-lg" aria-hidden="true">
          <FiHeart className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
        </div>

        <div className="absolute bottom-2 sm:bottom-12 lg:bottom-20 -left-3 sm:-left-5 bg-linear-to-r from-orange-500 to-yellow-500 rounded-full p-2 sm:p-3 lg:p-4 shadow-lg" aria-hidden="true">
